            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col text-center">
                        ...
                        <Link to={"/"} className="btn text-white bg-dark rounded-0 my-5">Volver al Inicio</Link>
                    </div>
                </div>
            </div>
        )
    ...
    return (
        <div className="container my-5">
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ? <div className="alert alert-light" role="alert">¡Felicitaciones! por tu compra N°: <b>{orderId}</b></div> : ""}
                </div>
            </div>
        </div>
    )
